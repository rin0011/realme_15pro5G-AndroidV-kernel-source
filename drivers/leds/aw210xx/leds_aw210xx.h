...
struct aw210xx_platform_data {
	...
	int led_mode;
	int br_brightness[LED_MAX_NUM*3];
	int color[LED_MAX_NUM*3];
	int rise_time_ms;
	int hold_time_ms;
	int fall_time_ms;
	int off_time_ms;
...
struct aw210xx {
	...
	int led_groups_num;
	int led_allocation_order[LED_MAX_NUM*3];
...
static AW_COLORFUL_INTERFACE_STRUCT aw210xx_interface[MAX_EFFECT];//aw_lamp_interface.h�ж����ýṹ��
...
static AW_COLOR_STRUCT source_color[MAX_EFFECT][RGB_NUM];//leds_aw210xx_reg.h�ж��壬���������ͺ����Ľṹ��
static AW_COLOR_STRUCT destination_color[MAX_EFFECT][RGB_NUM];
static ALGO_DATA_STRUCT algo_data[MAX_EFFECT];//aw_breath_algorithm.h�ж���
