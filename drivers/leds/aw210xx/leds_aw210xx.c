...
static void aw210xx_breath_reset(struct aw210xx *aw210xx, bool flag);
void streamer_mode_func(struct aw210xx *aw210xx,uint32_t breath_rate);
void flow_mode_func(struct aw210xx *aw210xx,uint32_t breath_rate);
void reset_led(void);
...
void run_music_effect(struct aw210xx *aw210xx){
	...
	AW_LOG(" effect_state.data[AW210XX_LED_MUSICMODE] = %d, last_run_effect = %d", effect_state.data[AW210XX_LED_MUSICMODE], last_run_effect);
	flow_mode_func(aw210xx,flow_rate);
	/*
...
void run_flow_effect(struct aw210xx *aw210xx){
	...
	AW_ERR(" effect_state.data[AW210XX_LED_MUSICMODE] = %d, last_run_effect = %d", effect_state.data[AW210XX_LED_FLOW_CTL_MODE], last_run_effect);
	if( (effect_state.data[AW210XX_LED_FLOW_CTL_MODE] == 1) || (last_run_effect != AW210XX_LED_FLOW_CTL_MODE)) {
		effect_state.data[AW210XX_LED_FLOW_CTL_MODE] = 0;
	}
	//flow_mode_func(aw210xx,flow_rate);
}

static int rain_color[8] = {0x640000,0x640A00,0x641900,0x1E5A00,0x0F281E,0x000A64,0x640064,0x640005};
void run_rainbow_effect(struct aw210xx *aw210xx){
	int i = 0;
		for(i=0;i<8;i++){
			if(i == 6){
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL00,(rain_color[i]>>16)&0xff);
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL01,(rain_color[i]>>8)&0xff);
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL02,(rain_color[i])&0xff);

				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL03,(rain_color[7]>>16)&0xff);
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL04,(rain_color[7]>>8)&0xff);
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL05,(rain_color[7])&0xff);

				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL06,(rain_color[0]>>16)&0xff);
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL07,(rain_color[0]>>8)&0xff);
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL08,(rain_color[0])&0xff);

				aw210xx_i2c_write(aw210xx,0x45,0x00);
				usleep_range(flow_rate*1000, flow_rate*1200);
			}else if(i == 7) {
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL00,(rain_color[i]>>16)&0xff);
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL01,(rain_color[i]>>8)&0xff);
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL02,(rain_color[i])&0xff);

				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL03,(rain_color[0]>>16)&0xff);
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL04,(rain_color[0]>>8)&0xff);
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL05,(rain_color[0])&0xff);

				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL06,(rain_color[1]>>16)&0xff);
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL07,(rain_color[1]>>8)&0xff);
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL08,(rain_color[1])&0xff);
				...
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL03,(rain_color[i+1]>>16)&0xff);
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL04,(rain_color[i+1]>>8)&0xff);
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL05,(rain_color[i+1])&0xff);

				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL06,(rain_color[i+2]>>16)&0xff);
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL07,(rain_color[i+2]>>8)&0xff);
				aw210xx_i2c_write(aw210xx, AW210XX_REG_SL08,(rain_color[i+2])&0xff);
...
void run_rainbow_effect(struct aw210xx *aw210xx){
int i;
	if( (effect_state.data[AW210XX_LED_RAINBOW_CTL_MODE] == 1) || (last_run_effect != AW210XX_LED_RAINBOW_CTL_MODE)) {
		effect_state.data[AW210XX_LED_RAINBOW_CTL_MODE] = 0;
	}
	
		for(i =0;i<8;i++){

			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL00,(multi_color[0][i]>>16)&0xff);
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL01,(multi_color[0][i]>>8)&0xff);
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL02,(multi_color[0][i])&0xff);
			
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL03,(multi_color[1][i]>>16)&0xff);
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL04,(multi_color[1][i]>>8)&0xff);
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL05,(multi_color[1][i])&0xff);
			
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL06,(multi_color[2][i]>>16)&0xff);
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL07,(multi_color[2][i]>>8)&0xff);
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL08,(multi_color[2][i])&0xff);
			
			AW_ERR("kevin1 rainbow flow_rate = %d,i=%d,multi_color[0][i]=%x,multi_color[1][i]=%x,multi_color[2][i]=%0x\n",flow_rate,i,multi_color[0][i],multi_color[1][i],multi_color[2][i]);
			aw210xx_i2c_write(aw210xx,0x45,0x00);
			usleep_range(flow_rate*1000, flow_rate*1200);
			
			
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL00,(multi_color[2][i]>>16)&0xff);
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL01,(multi_color[2][i]>>8)&0xff);
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL02,(multi_color[2][i])&0xff);
			
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL03,(multi_color[0][i]>>16)&0xff);
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL04,(multi_color[0][i]>>8)&0xff);
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL05,(multi_color[0][i])&0xff);
			
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL06,(multi_color[1][i]>>16)&0xff);
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL07,(multi_color[1][i]>>8)&0xff);
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL08,(multi_color[1][i])&0xff);
			
			AW_ERR("kevin2 rainbow flow_rate = %d\n",flow_rate);
			aw210xx_i2c_write(aw210xx,0x45,0x00);
			usleep_range(flow_rate*1000, flow_rate*1200);
			
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL00,(multi_color[1][i]>>16)&0xff);
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL01,(multi_color[1][i]>>8)&0xff);
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL02,(multi_color[1][i])&0xff);
			
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL03,(multi_color[2][i]>>16)&0xff);
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL04,(multi_color[2][i]>>8)&0xff);
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL05,(multi_color[2][i])&0xff);
			
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL06,(multi_color[0][i]>>16)&0xff);
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL07,(multi_color[0][i]>>8)&0xff);
			aw210xx_i2c_write(aw210xx, AW210XX_REG_SL08,(multi_color[0][i])&0xff);
...
void run_effect(struct aw210xx *aw210xx)
{
	while (1)
	{
		...
		else if (effect_state.state[AW210XX_LED_FLOW_CTL_MODE] != 0){
			AW_LOG("aw210xx hw AW210XX_LED_MUSICMODE\n");
			run_flow_effect(aw210xx);
			last_run_effect = AW210XX_LED_FLOW_CTL_MODE;
			usleep_range(3000,5000);
			break;
		}
		else if (effect_state.state[AW210XX_LED_RAINBOW_CTL_MODE] != 0){
			AW_LOG("aw210xx hw run_rainbow_effect\n");
			run_rainbow_effect(aw210xx);
			last_run_effect = AW210XX_LED_RAINBOW_CTL_MODE;
			usleep_range(3000,5000);
			continue;
		}
...
static void aw210xx_brightness(struct aw210xx *led)
{
	...
	if (led->pdata->led_mode == AW210XX_LED_INDIVIDUAL_CTL_BREATH || led->pdata->led_mode == AW210XX_LED_MULTI_CTL_BREATH
	    || led->pdata->led_mode == AW210XX_LED_FLOW_CTL_MODE || camera_mutli) {
		/*red led, green led max current is 20ma, blue led max current is 10ma*/
		for (i = 0; i < led_groups_num; i++) {
			if (led->id == 0) {
				color[i] = (led->pdata->color[i]);
				AW_LOG("id = %d set color[%d] = %d\n", led->id, i, color[i]);
			} else if (led->id == 1) {
				color[i] = (led->pdata->color[i]);
				AW_LOG("id = %d set color[%d] = %d\n", led->id, i, color[i]);
		...
		if(led->pdata->led_mode == AW210XX_LED_MULTI_CTL_BREATH || led->pdata->led_mode == AW210XX_LED_FLOW_CTL_MODE || camera_mutli) {
			color[led->id] = led->pdata->color[led->id];
			color[led->id+3] = led->pdata->color[led->id+3];
			color[led->id+6] = led->pdata->color[led->id+6];
			AW_LOG("kevin color[%d]=%d color[%d]= %d,color[%d]= %d\n", led->id,color[led->id],led->id+3, color[led->id+3],led->id+6, color[led->id+6]);
		}
		...
		if (led_groups_num == 2) {
			...
			AW_LOG("id = %d led_groups_num = %d \n", led->id, led_groups_num);
		} else if (led_groups_num == 3) {
			aw210xx_i2c_write(led, AW210XX_REG_SL00 + led->id, color[0+led->id]);
			aw210xx_i2c_write(led, AW210XX_REG_SL03 + led->id, color[3+led->id]);
			aw210xx_i2c_write(led, AW210XX_REG_SL06 + led->id, color[6+led->id]);
			aw210xx_i2c_write(led, AW210XX_REG_GCFG, 0x4F);
			AW_LOG("id = %d led_groups_num = %d \n", led->id, led_groups_num);
		} else if (led_groups_num == 4) {
			aw210xx_i2c_write(led, AW210XX_REG_SL00 + led->id, color[0]);
	...
	if (led->pdata->led_mode == AW210XX_LED_CCMODE ||led->pdata->led_mode == AW210XX_LED_FLOW_CTL_MODE
	...
	if (led->pdata->led_mode == AW210XX_LED_BREATHMODE || led->pdata->led_mode == AW210XX_LED_INDIVIDUAL_CTL_BREATH || led->pdata->led_mode == AW210XX_LED_MULTI_CTL_BREATH) {
		...
		aw210xx_i2c_write(led, AW210XX_REG_GBRL, 0x00);
		aw210xx_i2c_write(led, AW210XX_REG_ABMCFG, 0x03);
		aw210xx_i2c_write(led, AW210XX_REG_ABMGO, 0x03);
		...
		if (led_groups_num == 8 && aw210xx_id1 != NULL) {
			...
			aw210xx_i2c_write(aw210xx_id1, AW210XX_REG_ABMGO, 0x03);
		}
	...
	/* update */
	if(led->pdata->led_mode == AW210XX_LED_MULTI_CTL_BREATH || led->pdata->led_mode == AW210XX_LED_BREATHMODE){
		aw210xx_breath_reset(led, true);
	}
	...
	switch(led->pdata->led_mode) {
		...
		case AW210XX_LED_RAINBOW_CTL_MODE:
			...
			/*light effect*/
			AW_ERR(" effect_state.state[AW210XX_LED_FLOW_CTL_MODE]= %d \n", effect_state.state[AW210XX_LED_FLOW_CTL_MODE]);
			run_effect(led);
	...
	AW_LOG("%s:  brightness[%d]=%x led_mode[%d]=%d \n",__func__,led->id,led_brightness,led->id,led->pdata->led_mode);

out:
	AW_LOG("workqueue_flow_flag effect_state.state=%d,workqueue_flow_flag=%d,none_mode=%d\n",effect_state.state[AW210XX_LED_FLOW_CTL_MODE],workqueue_flow_flag,none_mode);
	if(effect_state.state[AW210XX_LED_FLOW_CTL_MODE]==1 && !workqueue_flow_flag){
	...
	} else if ((effect_state.state[AW210XX_LED_FLOW_CTL_MODE]==0||none_mode==1)&&workqueue_flow_flag){
...
static void flow_work_func(struct work_struct *aw210_work)
{
    ...
    if(effect_state.state[AW210XX_LED_FLOW_CTL_MODE]==1) {
		AW_LOG("flow_work_func enter AW210XX_LED_FLOW_CTL_MODE\n");
		flow_mode_func(led,flow_rate);
		queue_delayed_work(led->aw210_led_flow, &led->flow_led_work,0);
	}
}
...
static void aw210xx_breath_reset(struct aw210xx *aw210xx, bool flag)
{
	AW_ERR("%s\n",__func__);
	if(flag){
		aw210xx_i2c_write(aw210xx,AW210XX_REG_ABMCFG, 0x00);
		aw210xx_i2c_write(aw210xx,AW210XX_REG_ABMGO, 0x00);
		aw210xx_i2c_write(aw210xx,AW210XX_REG_ABMCFG, 0x03);
		aw210xx_i2c_write(aw210xx,AW210XX_REG_ABMGO, 0x03);
	}else {
		AW_ERR("aw210xx_breath_reset is null\n");
	}
	return;
}
static int aw210xx_led_init(struct aw210xx *aw210xx)
	...
	struct device_attribute *attr, const char *buf, size_t cnt)
{
	...
	char *str = NULL;
	char *p_buf, *tmp_buf;
	int i = 0, led_color[LED_MAX_NUM*3] = {0};
	int *led_order;
	int led_groups_num = led->pdata->led->led_groups_num;
	ssize_t ret = -EINVAL;
	...
	AW_LOG("[%d]: led_order=%d,%d,%d.\n",
		led->id, led_order[0], led_order[1], led_order[2]);
	...
	if (i == led_groups_num) {
		AW_LOG("[%d]: led_color=%d,%d,%d.\n",led->id, led_color[0], led_color[1], led_color[2]);
		mutex_lock(&led->pdata->led->lock);
			led->pdata->color[led->id] = led_color[0];
			led->pdata->color[led->id+3] = led_color[1];
			led->pdata->color[led->id+6] = led_color[2];
			flow_color[led->id] = led->pdata->color[led->id];
			flow_color[led->id+3] = led->pdata->color[led->id+3];
			flow_color[led->id+6] = led->pdata->color[led->id+6];
		mutex_unlock(&led->pdata->led->lock);
		AW_LOG("[%d]: led_color=%d,%d,%d.\n",led->id, led->pdata->color[led->id], led->pdata->color[led->id+3], led->pdata->color[led->id+6]);
	} else {
		AW_LOG("[%d]: input error.\n",led->id);
	}
	kfree(p_buf);
	...
	switch(effect_index) {
		...
		case RAINBOW_EFFECT:
			...
			for(i=1;i<8;i++)
			{
				...
				rgb = data;
				multi_color[br_rgb][i] = rgb; 
			AW_ERR("multi_color[%d][%d]=%08X\n",br_rgb,i,multi_color[br_rgb][i]);
			}
			break;
		default:
			break;
	...
	struct device_attribute *attr, const char *buf, size_t cnt)
{
	...
	if(lmode >=0 &&  lmode<AW210XX_LED_MAXMODE)
	{
		...
		}else if (lmode == AW210XX_LED_BREATHMODE) {
			if(val == 2){
				none_mode = 1;
				AW_ERR("kevin AW210XX_LED_BREATHMODE\n");
			}
	...
	struct device_attribute *attr, const char *buf, size_t cnt)
{
	...
	flow_rate = led->pdata->hold_time_ms;
	if(led->pdata->hold_time_ms == 0xaf){
		camera_mutli = 1;
		AW_LOG("camera_mutli=1\n");
	}else {
		camera_mutli = 0;
		AW_LOG("camera_mutli=0\n");
	}
	mutex_unlock(&led->pdata->led->lock);
...
//  added breathing mode interrupt reset interface by danchuanm@vanyol.com 
static ssize_t aw210xx_breath_reset_store(struct device *dev,
	struct device_attribute *attr, const char *buf, size_t cnt)
{
	unsigned long data = 0;
	struct led_classdev *led_cdev = dev_get_drvdata(dev);
	...
	if (value > 0)
		aw210xx_breath_reset(aw210xx, true);
	else
		aw210xx_breath_reset(aw210xx, false);
...
void streamer_mode_func(struct aw210xx *aw210xx,uint32_t flow_rate)
{
	u8 sl_val[9] = {0};
	int i = 0;
    AW_LOG("@kevin %s flow_rate=%d\n",__func__,flow_rate);
    for(i=0;i<9;i++){
		aw210xx_i2c_read(aw210xx, AW210XX_REG_SL00+i, &sl_val[i]);
		AW_LOG("@kevin %s sl_val[%d]=%d\n",__func__,i,sl_val[i]);
	}
	while(1){
		for(i=0;i<3;i++){
			aw210xx_i2c_write(aw210xx,AW210XX_REG_SL00+i,sl_val[i]);
		}
		for(i=0;i<3;i++){
			aw210xx_i2c_write(aw210xx,AW210XX_REG_SL03+i,sl_val[3+i]);
		}
		for(i=0;i<3;i++){
			aw210xx_i2c_write(aw210xx,AW210XX_REG_SL06+i,sl_val[6+i]);
		}
		AW_LOG("@kevin %s flow_rate=%d,sl_val[0]=%d,val[3]=%d,val[6]=%d\n",__func__,flow_rate,sl_val[0],sl_val[3],sl_val[6]);
		aw210xx_i2c_write(aw210xx,0x45,0x00);
		usleep_range(flow_rate*1000, flow_rate*1200);
		
		for(i=0;i<3;i++){
			aw210xx_i2c_write(aw210xx,AW210XX_REG_SL00+i,sl_val[6+i]);
		}
		for(i=0;i<3;i++){
			aw210xx_i2c_write(aw210xx,AW210XX_REG_SL03+i,sl_val[i]);
		}
		for(i=0;i<3;i++){
			aw210xx_i2c_write(aw210xx,AW210XX_REG_SL06+i,sl_val[3+i]);
		}
		aw210xx_i2c_write(aw210xx,0x45,0x00);
		usleep_range(flow_rate*1000, flow_rate*1200);
		AW_LOG("@kevin2 %s sl_val[0]=%d,val[3]=%d,val[6]=%d\n",__func__,sl_val[0],sl_val[3],sl_val[6]);
		for(i=0;i<3;i++){
			aw210xx_i2c_write(aw210xx,AW210XX_REG_SL00+i,sl_val[3+i]);
		}
		for(i=0;i<3;i++){
			aw210xx_i2c_write(aw210xx,AW210XX_REG_SL03+i,sl_val[6+i]);
		}
		for(i=0;i<3;i++){
			aw210xx_i2c_write(aw210xx,AW210XX_REG_SL06+i,sl_val[i]);
		}
		aw210xx_i2c_write(aw210xx,0x45,0x00);
		usleep_range(flow_rate*1000, flow_rate*1200);
		AW_LOG("@kevin3 %s sl_val[0]=%d,val[3]=%d,val[6]=%d\n",__func__,sl_val[0],sl_val[3],sl_val[6]);
	}
}
void flow_mode_func(struct aw210xx *aw210xx,uint32_t flow_rate)
{
	u8 sl_val[9] = {0};
	int i = 0;

    for(i=0;i<9;i++){
		sl_val[i] =flow_color[i];
		//aw210xx_i2c_read(aw210xx, AW210XX_REG_SL00+i, &sl_val[i]);
		AW_LOG("@kevin %s sl_val[%d]=%d\n",__func__,i,sl_val[i]);
	}
	if(none_mode ==1){
		AW_LOG("@kevin 1 none_mode %s\n",__func__);
		none_mode = 0;
		return;
	}
	for(i=0;i<3;i++){
...
static ssize_t aw210xx_effect_mode_store(struct device *dev,
		struct device_attribute *attr,
		const char *buf, size_t len)
{
	...
	uint32_t breath_rate = 0;
	uint32_t rgb_brightness = 0;


	if (sscanf(buf, "%x %x %x", &effect_mode, &breath_rate, &rgb_brightness) != 3)
		return len;
	
	printk("@kevin %s effect_mode=%d breath_rate=%d\n",__func__,effect_mode,breath_rate);
	switch(effect_mode) {
		case STREAMER:
			streamer_mode_func(aw210xx,breath_rate);
			break;
		case JUMP:
			printk("kevin dump\n");
			break;
		case FLY_WHEEL:
			printk("kevin fly_wheel\n");
			break;
		default:
			printk("kevin default\n");
			break;
	}
	return len;
}
...
static DEVICE_ATTR(breath_reset, 0664, NULL, aw210xx_breath_reset_store);
static DEVICE_ATTR(effect_mode, 0664, NULL, aw210xx_effect_mode_store);
...
static struct attribute *aw210xx_attributes[] = {
	...
	&dev_attr_tr1.attr,
	&dev_attr_tf1.attr,
	&dev_attr_breath_reset.attr,
	&dev_attr_effect_mode.attr,
	NULL,
};
		...
		enum AW2023_LED_MODE mode)
{
	...
	switch(mode) {
		...
		case AW210XX_LED_BREATHMODE:
			...
			led->pdata->rise_time_ms = 1;
			led->pdata->fall_time_ms = 1;
		...
		case AW210XX_LED_INDIVIDUAL_CTL_BREATH:
			...
			break;
		case AW210XX_LED_MULTI_CTL_BREATH:
			led->pdata->hold_time_ms = 0;
			led->pdata->off_time_ms =  0;
			led->pdata->rise_time_ms = 6;
			led->pdata->fall_time_ms = 6;
			led->pdata->led_mode = AW210XX_LED_MULTI_CTL_BREATH;
			break;
		case AW210XX_LED_FLOW_CTL_MODE:
...
static int aw210xx_led_multicolor_ctl_breath_activate(struct led_classdev *cdev)
{
	int ret = 0;
	struct aw210xx *led = container_of(cdev, struct aw210xx, cdev);
	...
	ret = aw210xx_led_change_mode(led, AW210XX_LED_MULTI_CTL_BREATH);
	if (ret < 0) {
		dev_err(led->cdev.dev, "%s: aw210xx_led_change_mode fail\n", __func__);
		return ret;
	}
...
static void aw210xx_led_multicolor_ctl_breath_deactivate(struct led_classdev *cdev)
{
	struct aw210xx *led = container_of(cdev, struct aw210xx, cdev);
	aw210xx_led_change_mode(led, AW210XX_LED_NONE);
...
//		.groups = aw210xx_led_individual_ctl_breath_mode_groups,
	...
	{
		.name = "multicolor_ctl_breath",
		.activate = aw210xx_led_multicolor_ctl_breath_activate,
		.deactivate = aw210xx_led_multicolor_ctl_breath_deactivate,
//		.groups = aw210xx_led_multicolor_ctl_breath_mode_groups,
	},
	{
		.name = "flow_ctl_mode",
...
static int aw210xx_i2c_probe(struct i2c_client *i2c)
{
	...
	if (gpio_is_valid(aw210xx->enable_gpio)) {
		...
		if (ret) {
			AW_ERR("enable gpio request failed,ret=%d\n",ret);
	...
	if (aw210xx->aw210xx_led_id == 0) {
		if (gpio_is_valid(aw210xx->vbled_enable_gpio)) {
			...
			if (ret) {
				AW_ERR("vbled enable gpio request failed ret=%d\n",ret);
				goto err_gpio_request;
			}
		}
...
static void aw210xx_i2c_remove(struct i2c_client *i2c)
{
	...
	AW_LOG("aw210xx_i2c_remove enter\n");
